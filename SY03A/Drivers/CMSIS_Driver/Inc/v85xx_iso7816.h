/**
  ...
  ******************************************************************************
  */
#ifndef __V85XX_ISO7816_H
#define __V85XX_ISO7816_H
...
//AUTOMODE
#define ISO7816_AUTOMODE_RETRANSMIT ISO7816_CFG_AUTOSD
#define ISO7816_AUTOMODE_RERECEIVE  ISO7816_CFG_AUTORC
#define ISO7816_AUTOMODE_OFF        0
#define ISO7816_AUTOMODE_Msk        (ISO7816_AUTOMODE_RETRANSMIT|ISO7816_AUTOMODE_RERECEIVE)
#define IS_ISO7816_AUTOMODE(__AUTOMODE__)  (((((__AUTOMODE__) & ISO7816_AUTOMODE_Msk) != 0U) && (((__AUTOMODE__) & ~ISO7816_AUTOMODE_Msk) == 0U)) ||\
                                            ((__AUTOMODE__) == ISO7816_AUTOMODE_OFF))
//Parity
...
#define IS_ISO7816_BAUDRATE(__BAUDRATE__) ((__BAUDRATE__) > 300UL)

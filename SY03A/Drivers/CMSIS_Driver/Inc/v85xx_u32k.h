/**
  ...
  ******************************************************************************
  */
#ifndef __V85XX_U32K_H
#define __V85XX_U32K_H
...
//WKUMode
#define U32K_MKUMOD_RX  0                  // Wake-up when receive data
#define U32K_MKUMOD_PC  U32K_CTRL0_WKUMODE // Wake-up when receive data and parity/stop bit correct 
...
#define IS_U32K_WKUMODE(__WKUMODE__)  (((__WKUMODE__) == U32K_MKUMOD_RX) || ((__WKUMODE__) == U32K_MKUMOD_PC))

...
/**
  * @brief  Deinitializes the Tiny ADC peripheral registers to their default reset values.
  * @param  None
  * @retval None
  */
...
void TADC_StructInit(TADCInitType* TADC_InitStruct)
{
  ...
  TADC_InitStruct->SignalSel = ADCTINY_SIGNALSEL_SEG61;
...
/**
  ...
  * @param  TADC_InitStruct
                SelADT:
                    ADCTINY_SIGNALSEL_SEG61
                    ADCTINY_SIGNALSEL_SEG60
                ADTREF1:
                    ADCTINY_REF1_0_9
                    ADCTINY_REF1_0_7
                ADTREF2:

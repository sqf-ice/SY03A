...
/**
  ...
  *             1. Enable BGP.
  *             2. Enable 6.5M RC ,AHB clock source switch to RCH.
  *             3. configure clock (except AHB clock source configuration).     - optional
  *             4. configure AHB clock source.                                  - optional
  *             5. HCLK/PCLK divider configuration.                             - optional
  *

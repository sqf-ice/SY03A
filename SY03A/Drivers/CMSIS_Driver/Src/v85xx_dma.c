...
/**
  * @brief  Deinitializes the DMA Cx peripheral registers to their default reset values.
...
/**
  * @brief  Deinitializes the DMA AES channel3 registers to their default reset values.
  * @param  None
  * @retval None
  */

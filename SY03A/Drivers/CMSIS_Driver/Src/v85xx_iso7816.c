  ...
  * @param  ISO7816x: ISO78160~ISO78161
            Init_Struct:iso7816 configuration.
                ...
                ACKLen:
                    ISO7816_ACKLEN_1
                    ISO7816_ACKLEN_2
                AutoMode: (between ISO7816_AUTOMODE_RETRANSMIT and ISO7816_AUTOMODE_RERECEIVE, can use the ¡®|¡¯ operator)
                    ISO7816_AUTOMODE_RETRANSMIT
                    ISO7816_AUTOMODE_RERECEIVE
                    ISO7816_AUTOMODE_OFF
                Parity:
                    ISO7816_PARITY_EVEN
                    ISO7816_PARITY_ODD
...
void ISO7816_Init(ISO7816_TypeDef *ISO7816x, ISO7816_InitType *Init_Struct)
{
  ...
  assert_parameters(IS_ISO7816_AUTOMODE(Init_Struct->AutoMode));
...
void ISO7816_StructInit(ISO7816_InitType *InitStruct)
{
  ...
  /* Initialize the AutoMode member */ 
  InitStruct->AutoMode = ISO7816_AUTOMODE_OFF;

...
* TIME. AS A RESULT, VANGOTECH SHALL NOT BE HELD LIABLE FOR ANY DIRECT,
...
#define __Vendor_SysTickConfig 0 /*!< V85XX uses systick config */
#define __NVIC_PRIO_BITS  2   /*!< V85XX uses 2 Bits for the Priority Levels */
...
/******  V85XX specific Interrupt Numbers ********************************************************************/
...
typedef struct
{
  ...
  __IO uint32_t IOAINT;         /*!< IOA input status register,                               Address offset: 0x28 */
  ...
  __IO uint32_t VERSIONID_;     /*!< Version ID of Vango chip,                                Address offset: 0x3C */
...
#define ANA_REG2_REFSEL_CMPA_Pos      (4U)                                     
#define ANA_REG2_REFSEL_CMPA_Msk      (0x1U << ANA_REG2_REFSEL_CMPA_Pos)       /*!< 0x00000010 */
#define ANA_REG2_REFSEL_CMPA           ANA_REG2_REFSEL_CMPA_Msk                /*!< REF selection of CMPA */ 
#define ANA_REG2_REFSEL_CMPB_Pos      (5U)                                     
#define ANA_REG2_REFSEL_CMPB_Msk      (0x1U << ANA_REG2_REFSEL_CMPB_Pos)       /*!< 0x00000020 */
#define ANA_REG2_REFSEL_CMPB           ANA_REG2_REFSEL_CMPB_Msk                /*!< REF selection of CMPB */ 
...
#define ANA_REGF_VD33OFF_Pos          (2U)
#define ANA_REGF_VD33OFF_Msk          (0x1U << ANA_REGF_VD33OFF_Pos) 
#define ANA_REGF_VD33OFF               ANA_REGF_VD33OFF_Msk
...
#define PMU_IOAINT       (volatile unsigned *)(PMU_BASE + 0x0028)
